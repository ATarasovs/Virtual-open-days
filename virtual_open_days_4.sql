...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2018 at 01:20 AM
...
(1, 'Student Gender Mix', 'pie'),
(3, 'Student Gender Mix', 'doughnut'),
(5, 'sdsdsdaaaa', 'horizontalBar'),
(6, 'aaaasssssss', 'polarArea'),
(7, '', '');
...
(2, 'admin', '1145de898ec6d3d5892820ca29c33fff', '5a9d67dfb46855.01454040', NULL, 'Admin', 'Administrator', 'admin@admin.com', '0756456731', 'United Kingdom', 'Dundee', 'Administrator', '12/09/1995', 'true', 'true', '0000-00-00 00:00:00', 'admin.png'),
(39, 'atarasovs', '7f3dcb78f0c1b66eefb0606cef851ade', '5a9d6843c38397.57217735', NULL, 'Aleksandrs', 'Tarasovs', 'a.tarasov1209@gmail.com', '07563710331', 'Latvia', 'Riga', 'Student', '12/09/1995', 'false', 'true', '2018-03-05 00:00:00', 'atarasovs.png');
...
--
ALTER TABLE `media`
  MODIFY `mediaId` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `users`
  MODIFY `userId` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
