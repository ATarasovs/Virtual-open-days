                   ...
                   <tbody>
                       ...
                       <tr class="table-info">
                           ...
                           <td class="col-xs-3">
                               ...
                               <button class="removeBtn btn btn-danger btn-sm" data-event-id="<?php echo $event->eventId; ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-times" aria-hidden="true"></i> Delete</button>
                           </td>
                       </tr>
                      <?php } ?>
                   </tbody>    
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure that you want to remove this event?</p>
            </div>
...
<script>
    ...
    var eventDeleteReqUrl = '<?php print Yii::app()->createUrl('events/events/deleterecord') ?>';
</script>
