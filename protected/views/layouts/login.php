    ...
    <div class="container-full">
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item">
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/2.jpg" alt="Chicago" style="width:100%;">
                </div>

                <div class="item">
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/3.jpg" alt="New york" style="width:100%;">
                </div>
            </div>
